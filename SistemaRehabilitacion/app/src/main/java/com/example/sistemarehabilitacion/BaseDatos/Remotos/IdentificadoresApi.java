...
public class IdentificadoresApi {
    ...
    public static String direcccion = "192.168.100.2";
    public final static String ruta_base = "http://192.168.100.2/api_rehabilitacion/index.php/";//debería cambiarse la ip por un dns
